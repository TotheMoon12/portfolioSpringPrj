	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="border js-fullheight">
			<div class="text-center">
				...
				<h1 id="colorlib-logo"><a href="index.html">서민우</a></h1>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --> </span> <span>Distributed by <a href="https://themewagon.com" target="_blank">ThemeWagon</a></span> <span>Demo Images: <a href="https://unsplash.com/" target="_blank">Unsplash.com</a></span></small></p>
				<ul>
					<li><a href="https://github.com/TotheMoon12"><i class="fa-brands fa-github"></i></a></li>					
				</ul>
			</div>
				         ...
				         <div class="timeline-centered">
					         <article class="timeline-entry animate-box" data-animate-effect="fadeInLeft">
					            <div class="timeline-entry-inner">
					               ...
					               <div class="timeline-label">
					                  <h2>대구경원고등학교 <span> 2011-2014</span></h2>
					               </div>
					            </div>
					         </article>
					         ...
					         <article class="timeline-entry animate-box" data-animate-effect="fadeInRight">
					            <div class="timeline-entry-inner">
					               ...
					               <div class="timeline-label">
					               		<h2>영남대학교 <span>2014-2021</span></h2>
					               </div>
					            </div>
					         </article>
					      </div>
				         ...
				         <div class="timeline-centered">
					         <article class="timeline-entry animate-box" data-animate-effect="fadeInLeft">
					            <div class="timeline-entry-inner">
					               ...
					               <div class="timeline-label">
									  <h2 >영남대학교 연구실<span>2017-2018</span></h2>									  
					                  <p> 영남대학교 정보통신공학과 보안연구실에서 국토부 친환경 탄소서비스 과제의 블록체인파트에 참여</p>									  
					               </div>
					            </div>
					         </article>
					      </div>
				         ...
				         <div class="timeline-centered">
					         <article class="timeline-entry animate-box" data-animate-effect="fadeInLeft">
					            <div class="timeline-entry-inner">
					               ...
					               <div class="timeline-label">
									  <h2 >IoT 경진대회<span>2020</span></h2>									  
					                  <p> 영남대학교 기계IT대학에서 주관하는 대학혁신사업단에서 후원하는 IoT 경진대회에서 최우수상 입상</p>
					               </div>
					            </div>
					         </article>
					      </div>
					...
					<div class="row">
						<div class="col-md-6 animate-box blockchain work" data-animate-effect="fadeInLeft">
							<div class="project" style="background-image: url(images/img-1.jpg);">
								<div class="desc">
									<div class="con">
										<h3><a name="overlay-projectTest" path="project/blockchain/voting.html" href="javascript:void(0);">hyperledger-fabric</a></h3>
										<span>Website</span>
										<p class="icon">
